...
import { LoginFormSchema, type LoginFormType } from "./auth.validetion";
...
export function Login({ className, ...props }: React.ComponentProps<"div">) {
  ...
  const onSubmit = async (data: LoginFormType) => {
    ...
    try {
      ...
      console.error(error);
      toast.error("Login failed! login credentials are not valid.");
    }
  };
  return (
    <>
      ...
      <div
        className={cn("flex flex-col gap-6 max-w-3xl my-24 mx-auto", className)}
        {...props}
      >
            ...
            <Form {...form}>
              ...
              >
                <div className="flex flex-col gap-6">
                  ...
                  />
                  <label className="flex items-center space-x-2 -mt-4 self-end hover:underline cursor-pointer">
